...
public class TokenService {
    ...
    public com.auth0.jwt.interfaces.DecodedJWT verificarTokenMfaTemporario(String tokenJWT) {
        try {
            var algoritmo = Algorithm.HMAC256(secret);
            ...
            throw new RegraDeNegocioException("Token MFA inválido ou expirado!");
        }
    }
